            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand mt-4">
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <p class="display-7 text-primary mb-1">
                                    <strong>{{ Auth::user()->mahasiswa->nama }}</strong>
                                </p>
                            </div>
                            <div class="row">
                                <p class="fs-6">{{ Auth::user()->mahasiswa->nrp }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Jadwal Sidang -->
                    <li class="menu-item {{ request()->is('mahasiswa/jadwalsidang') ? ' active' : '' }}">
                        <a href="{{ url('/mahasiswa/jadwalsidang') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user"></i>
                            <div>Jadwal Sidang</div>
                        </a>
                    </li>
                    <!-- Ganti Password -->
                    <li class="menu-item {{ request()->is('mahasiswa/gantipassword') ? ' active' : '' }}">
                        <a href="{{ url('/mahasiswa/gantipassword') }}" class="menu-link">
