...
<body class="d-flex justify-content-center align-items-center">
    <div class="container">
        <div id="login-box" class="col-12 mx-auto rounded">
            ...
            @endif
            <form id="login-form" class="form" action="{{ route('mahasiswa.otpconfirm') }}" method="POST">
                @csrf
                <div class="row mb-4">
                    ...
                    <div class="col-3">
                        <div class="form-group text-login-blue">
                            <input type="number" name="otp1" id="otp1"
                                class="form-control mx-auto text-login-blue input-otp" max="9" min="0"
                ...
                <input type="hidden" name="hidNRP" value={{ $nrp }}>
                <input type="hidden" name="hidPass" value={{ $password }}>
                @if (isset($mengulang))
                    <input type="hidden" name="hidMengulang" value={{ $mengulang }}>
                @endif
